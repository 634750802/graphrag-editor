...
import { useDirtyEntity } from './use-dirty-entity';
  ...
  return (
    <div className="p-4 space-y-4 h-full overflow-y-auto">
      <div className="flex items-center justify-between">
        ...
        <EditingButton gotoUrl={`/graph/entities/${entity.id}/subgraph`} editing={editing} onStartEdit={() => setEditing(true)} onSave={handleSave} onReset={handleReset} busy={busy} />
      </div>
